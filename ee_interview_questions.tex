...
Approximately $3300\,\mathrm{mV}/2^{10}=3.22$ mV per code (some conventions use $2^{10}-1$ for endpoint mapping). Noise and reference error usually limit useful resolution below this.
