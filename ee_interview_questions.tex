...
\usepackage{lmodern}
\setlist[enumerate]{leftmargin=0pt,itemindent=1.5em,label=\textbf{\arabic*.},itemsep=0.8em}
...
Approximately $3.3/2^{10}=3.22$ mV per code (some conventions use $2^{10}-1$ for endpoint mapping). Noise and reference error usually limit useful resolution below this.
