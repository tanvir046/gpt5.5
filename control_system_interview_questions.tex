...
For a standard second-order denominator $s^2+2\zeta\omega_ns+\omega_n^2$, $\zeta$ controls oscillation. For $0<\zeta<1$, percent overshoot is approximately $100e^{-\pi\zeta/\sqrt{1-\zeta^2}}$.
